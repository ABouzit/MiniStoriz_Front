...
export default function MesOeuvresPage(props) {
  ...
  const removeRequestFriend  = (id) => {
    Axios.delete(
      config.API_URL +
        "relations/between/"+userCurrent.id+"/"+id 
    ).then(res => {
      firebase.database().ref('relations/' + id).set({
        from: userCurrent.id,
        to: id,
      ...
      <div style={{backgroundColor: "#ecfbfc"}}>
        <GridContainer justify="center" style={{margin: 0, padding: 0}}>
          ...
          {user.lienCouverture == null ? (
            <Parallax image={config.API_URL + "images/asset/bg1.jpg"}
            style={{
              height: "240px",
              marginLeft: "auto",
              marginRight: "auto",
          ...
          <ButtonBase
                  ...
                  style={isMobile ? { width: "100%", display: 'contents' } : { width: "30%", display: 'contents' }}
                >
            <Parallax image={user.lienCouverture}
              style={{
                height: "240px",
                marginLeft: "auto",
                marginRight: "auto",
        ...
        <GridContainer justify="flex-end" style={{margin: 0}}>
          <GridItem xs={12} sm={12} md={3}>
                  ...
                  <GridContainer justify="center">
                    ...
                    <GridContainer justify="center" style={{ marginTop: "3%", height: 23 }}>
                      ...
                      <GridItem xs={4} sm={4} md={4} style={{ textAlign: "center" }}>
                        ...
                        <ButtonBase onClick={()=>{requestFriend(view)}}>
                          <small style={{color: '#1e1548'}}>
            ...
            <Snackbar open={requestF} autoHideDuration={8000}  onClose={handleClose}>
              <Alert onClose={handleClose} severity="success">
                Votre invitation a été envoyée
              </Alert>
            </Snackbar>
            <Snackbar open={requestRF} autoHideDuration={8000}  onClose={handleClose}>
              <Alert onClose={handleClose} severity="success">
